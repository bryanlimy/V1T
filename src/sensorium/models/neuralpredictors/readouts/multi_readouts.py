...
from sensorium.models.neuralpredictors.readouts.base import ClonedReadout
from sensorium.models.neuralpredictors.readouts.gaussian import FullGaussian2d
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i, data_key in enumerate(n_neurons_dict):
            ...
            mean_activity = (
                mean_activity_dict[data_key] if mean_activity_dict is not None else None
            )

            readout_kwargs = self.prepare_readout_kwargs(
                i, data_key, first_data_key, **kwargs
            )
        ...
        **kwargs,
        ...
        if share_features:
            readout_kwargs["shared_features"] = {
                ...
                if i == 0
                else self[first_data_key].shared_features,
            }
        else:
